...
export default function SourceSelector({ selectedType, onTypeChange, onFileUpload, onMicStream, audioData, micStream }: SourceSelectorProps): React.ReactNode {
       ...
       <h3 className="text-xl font-bold text-center text-cyan-400 mb-4">Source Audio</h3>
        ...
        <div className="flex-grow">
            {selectedType === SourceType.FILE ? (
                <AudioUploader id="source" title="" onUpload={onFileUpload} audioData={audioData} />
            ) : (
