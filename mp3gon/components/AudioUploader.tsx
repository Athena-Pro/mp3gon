...
export default function AudioUploader({ id, title, onUpload, audioData }: AudioUploaderProps): React.ReactNode {
      ...
      {audioData ? (
        <div className="flex-grow flex flex-col justify-between">
          <div className="flex-grow flex flex-col">
            <div className="bg-gray-900/50 rounded-lg border border-gray-700 h-48 mb-4 flex items-center justify-center overflow-hidden">
                <MP3gonVisualizer buffer={audioData.buffer} />
            </div>
